...
export default function Project(){
    ...
    <h1 className="font-bold text-3xl text-teal-400 text-center" >Projects</h1>
      <div className="sm:grid-cols-1 grid p-7 lg:grid-cols-3 border-2 border-white rounded-md space-x-2 space-y-2 gap-4">
           <div className=" shadow-2xl hover:shadow-2xl hover:shadow-slate-700  border-2 ml-2 mt-2 h-72 rounded-xl ">
            ...
            <p className="mx-auto pl-4 text-gray-700 from-neutral-100">A platform for Managing food managent of hospital</p>
             <a href="https://mern-stack-hospital-food-management-system-frontend.vercel.app" className="pl-32 text-blue-500 hover:underline">View Project</a>
              </div>
            </div>
            <div className=" shadow-2xl hover:shadow-2xl hover:shadow-slate-700  border-2 ml-2 mt-2 h-72 rounded-xl ">
            ...
            <div className=" shadow-2xl hover:shadow-2xl hover:shadow-slate-700  border-2 ml-2 mt-2 h-72 rounded-xl ">
            <h1 className="pl-24 pt-3 pb-2 font-medium">Cryptocurrency tracker usring reactjs </h1>
            ...
            <div className=" shadow-2xl hover:shadow-2xl hover:shadow-slate-700  border-2 ml-2 mt-2 h-72 rounded-xl ">
            <h1 className="pl-16 pt-3 pb-2"></h1>
             <hr/>  <img src={f1} className="mx-auto h-44 w-full px-8 py-2"/>
            <hr/>
            <div className="w-fit  ">
            <p className="mx-auto pl-11">A platform for buying books online.</p>
             <a href="https://mern-stack-hospital-food-management-system-frontend.vercel.app" className="pl-28 text-blue-500 hover:underline">View Project</a>
              </div>
            </div>
            <div className=" shadow-2xl hover:shadow-2xl hover:shadow-slate-700  border-2 ml-2 mt-2 h-72 rounded-xl ">
            <h1 className="pl-16 pt-3 pb-2">Hospital Food Management </h1>
             <hr/>  <img src={f1} className="mx-auto h-44 w-full px-8 py-2"/>
            <hr/>
            <div className="w-fit  ">
            <p className="mx-auto pl-11">A platform for buying books online.</p>
